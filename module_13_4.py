...
async def start(message: types.Message):
    await message.answer('Привет! Я бот, помогающий твоему здоровью. Напишите "Calories" для расчета нормы калорий.')
...
async def all_messages(message: types.Message):
    ...
    await message.answer(
        'Извините, я не понимаю это сообщение. Напишите "Calories" для расчета калорий или используйте команду /start.')
