...
from crud_functions import initiate_db, fill_products, get_all_products, add_user, is_included
import sqlite3
...
async def get_buying_list(message: types.Message):
    products = [
        {"name": "Product 1", "desc": "Описание 1", "price": 100,
         "img": "https://marketguru.io/secrets/wp-content/uploads/2023/05/3-2-768x511.jpg"},
        {"name": "Product 2", "desc": "Описание 2", "price": 200,
         "img": "https://www.mos.ru/upload/newsfeed/newsfeed/onlineshopping(9).jpg"},
        {"name": "Product 3", "desc": "Описание 3", "price": 300,
         "img": "https://alev.biz/wp-content/uploads/2021/11/online-shopping.jpg"},
        {"name": "Product 4", "desc": "Описание 4", "price": 400,
         "img": "https://thumbs.dreamstime.com/b/магазинная-тележкаа-28651333.jpg"}
    ]

    for product in products:
        await message.answer_photo(
            photo=product["img"],
            caption=f'Название: {product["name"]} | {product["desc"]} | Цена: {product["price"]}'
        )
